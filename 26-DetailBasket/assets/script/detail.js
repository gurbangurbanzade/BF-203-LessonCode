...
<section class="text-gray-700 body-font overflow-hidden bg-white">
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src="${element.image}">
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 class="text-sm title-font text-gray-500 tracking-widest">${element.category}</h2>
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">${element.title}</h1>
        <div class="flex mb-4">
          <span class="flex items-center">
            ...
            <span class="text-gray-600 ml-3">${element.rating.rate}</span>
          </span>
